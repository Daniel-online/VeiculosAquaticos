...
public class Iates extends Barcos {
    //Atributos
    ...
    public void imprimir(){
        ...
        if (piscina){
            System.out.println("Possui piscinas: sim" );
        } else {
            System.out.println("Possui piscinas: não" );
        }
    ...
    //Construtores
    public Iates(){}
    public Iates(String marca, String modelo, String id){
        super(marca, modelo, id);
    }
    public Iates(String marca, String modelo, String cor, String id, 
    ...
    public Iates(int numeroTripulantes, int numeroCabines, boolean piscina, String marca, String modelo, String cor, String id, int n, int vel, double p, double peso, double alt) {
        super(marca, modelo, cor, id, n, vel, p, peso, alt);
    ...
    public Iates(String marca, String modelo, int numPassageiros, int velocidade, double preco, double peso) {
        super(marca, modelo, numPassageiros, velocidade, preco, peso);
    }

    public Iates(String marca, String modelo, String id, String cor) {
        super(marca, modelo, id, cor);
    }

    public Iates(int numeroTripulantes, int numeroCabines, boolean piscina) {
        this.numeroTripulantes = numeroTripulantes;
        this.numeroCabines = numeroCabines;
        this.piscina = piscina;
    }

    public Iates(int numeroTripulantes, int numeroCabines) {
        this.numeroTripulantes = numeroTripulantes;
        this.numeroCabines = numeroCabines;
    }

    public Iates(int numeroTripulantes, String marca, String modelo, String cor, String id, int n, int vel, double p, double peso, double alt) {
        super(marca, modelo, cor, id, n, vel, p, peso, alt);
        this.numeroTripulantes = numeroTripulantes;
    }

    public Iates(String modelo) {
        setModelo(modelo);
        setCor("Dourado");
        setMarca("Austin");
