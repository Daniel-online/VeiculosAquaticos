...
public class Lanchas extends VeiculosAquaticos {
    ...
    public void cadastrar(String marca, String modelo, String cor, String identificacao, int NumeroPassageiros, int velocidadeMaxima, double preco, double peso, double alturaCalado, String tipoCasco, int banheiro){
